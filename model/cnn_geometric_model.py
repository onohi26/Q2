...
class FeatureRegression(nn.Module):
    def __init__(self, output_dim=6, use_cuda=True, batch_normalization=True, kernel_sizes=[7,5,5], channels=[256,128,64]):
...
class CNNGeometric(nn.Module):
    def __init__(self, output_dim=6, 
                 ...
                 fr_kernel_sizes=[7,5,6],
                 fr_channels=[256,128,64],
