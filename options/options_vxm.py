...
class ArgumentParser():
    ...
    def add_cnn_model_parameters(self):
        ...
        # Model parameters
        model_params.add_argument('--enc', type=int, nargs='+',
                    help='list of unet encoder filters (default: 16 32 32 32)')
        model_params.add_argument('--dec', type=int, nargs='+',
                    help='list of unet decorder filters (default: 32 32 32 32 32 16 16)')
        model_params.add_argument('--int-steps', type=int, default=7,
                    help='number of integration steps (default: 7)')
        model_params.add_argument('--int-downsize', type=int, default=1,
                    help='flow downsample factor for integration (default: 2)')
        model_params.add_argument('--bidir', default=False, action='store_true', help='enable bidirectional cost function')
 

    def add_base_train_parameters(self):
        base_params = self.parser.add_argument_group('base')
        # Image size
        base_params.add_argument('--image-size', type=int, default=256, help='image input size')
    ...
    def add_train_parameters(self):
        ...
        train_params.add_argument('--lambda', type=float, dest='weight', default=0.01,
        ...
        train_params.add_argument('--num-epochs', type=int, default=100, help='number of training epochs')
        ...
        train_params.add_argument('--image-loss', default='mse',help='image reconstruction loss - can be mse or ncc (default: mse)')
        train_params.add_argument('--geometric-model', type=str, default='tps', help='affine/hom/tps')
        ...
        train_params.add_argument('--training-dataset', type=str, default='ixi', help='dataset to use for training')
