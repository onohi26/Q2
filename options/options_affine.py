...
class ArgumentParser():
    ...
    def add_cnn_model_parameters(self):
        ...
        model_params.add_argument('--fr-kernel-sizes', nargs='+', type=int, default=[7,5,6], help='kernels sizes in feat.reg. conv layers')
        model_params.add_argument('--fr-channels', nargs='+', type=int, default=[256,128,64], help='channels in feat. reg. conv layers')
    ...
    def add_train_parameters(self):
        ...
        train_params.add_argument('--use-mse-loss', type=str_to_bool, nargs='?', const=True, default=True, help='Use MSE loss on tnf. parameters')        
