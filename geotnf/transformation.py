...
class ComposedGeometricTnf(object):
    ...
    """
    def __init__(self, tps_grid_size=3, tps_reg_factor=0, out_h=256, out_w=256, 
                 offset_factor=1.0,
...
class GeometricTnf(object):
    ...
    """
    def __init__(self, geometric_model='affine', tps_grid_size=3, tps_reg_factor=0, out_h=256, out_w=256, offset_factor=None, use_cuda=True):
        self.out_h = out_h
        self.out_w = out_w
...
class SynthPairTnf(object):
    ...
    """
    def __init__(self, use_cuda=True, geometric_model='affine', crop_factor=9/16, output_size=(256,256), padding_factor = 0.5, occlusion_factor=0):
